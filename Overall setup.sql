...
--CUSTOMID: STARTS WITH 'T' FOR TITLES, BRINGS ROWNUMBER FILLED OUT WITH 0s WHENEVER THE NUMBER IS SMALLER
--THAN A 6 DIGIT NUMBER.
SELECT ('T' + RIGHT(('00000' + CAST(IntId AS VARCHAR(10))), 6)) AS CustomId FROM AllTitles
GO

--ADD CUSTOMID COMPUTED COLUMN TO ALLTITLES TABLE AS PRIMARY KEY.
ALTER TABLE AllTitles
ADD CustomID AS ('T' + RIGHT(('00000' + CAST(IntId AS VARCHAR(10))), 6)) PERSISTED NOT NULL
GO
